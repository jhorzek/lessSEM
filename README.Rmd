...
(e.g., lasso is called with the `lasso()` function). Smooth approximations are called 
...
> **A short note on branches**: The lessSEM project has multiple branches. The **main**
