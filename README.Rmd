...
and should not be used. They will be marked as deprecated soon. 
...
Identical to [**regsem**](https://github.com/Rjacobucci/regsem), **lessSEM** is specified 
...
**lessSEM** are parameter transformations (see below for an example). Additionally,
**lessSEM** allows for mixed penalties. Finally, **lessSEM** can make use of multiple
cores.
