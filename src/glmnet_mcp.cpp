...
public:
  ...
  Rcpp::List optimize(Rcpp::NumericVector startingValues_, 
    ...
    lessSEM::tuningParametersMcpGlmnet tp;
    
    tp.lambda = lambda_;
    tp.theta = theta_;
    tp.weights = weights;
    
    lessSEM::penaltyMcpGlmnet penalty_;
    lessSEM::noSmoothPenalty<lessSEM::tuningParametersMcpGlmnet> smoothPenalty_;
...
//'
typedef glmnetMcp<SEMCpp> glmnetMcpSEM;
RCPP_EXPOSED_CLASS_NODECL(glmnetMcpSEM)
  RCPP_MODULE(glmnetMcpSEM_cpp){
    using namespace Rcpp;
    Rcpp::class_<glmnetMcpSEM>( "glmnetMcpSEM" )
      .constructor<arma::rowvec,Rcpp::List>("Creates a new glmnetMcpSEM.")
    // methods
    .method( "setHessian", &glmnetMcpSEM::setHessian, "Changes the initial hessian. Expects a matrix")
    .method( "optimize", &glmnetMcpSEM::optimize, "Optimizes the model. Expects SEM, labeled vector with starting values, lambda, and alpha")
    ;
  }
...
//'@returns a list with fit results
//'
typedef glmnetMcp<mgSEM> glmnetMcpMgSEM;
RCPP_EXPOSED_CLASS_NODECL(glmnetMcpMgSEM)
  RCPP_MODULE(glmnetMcpMgSEM_cpp){
    using namespace Rcpp;
    Rcpp::class_<glmnetMcpMgSEM>( "glmnetMcpMgSEM" )
      .constructor<arma::rowvec,Rcpp::List>("Creates a new glmnetMcpMgSEM.")
    // methods
    .method( "setHessian", &glmnetMcpMgSEM::setHessian, "Changes the initial hessian. Expects a matrix")
    .method( "optimize", &glmnetMcpMgSEM::optimize, "Optimizes the model. Expects SEM, labeled vector with starting values, lambda, and alpha")
    ;
  }
