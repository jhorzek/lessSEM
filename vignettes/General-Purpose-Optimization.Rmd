...
```
#> [1] 0.2984090 0.3063359 0.3034399 0.3024640 0.3015840
```

Runtime in seconds with gradients:

```
#> [1] 0.03875494 0.02914906 0.02906895 0.02836800 0.03837013
```
...
```
#> [1] 0.02187204 0.02358603 0.02075100 0.03280401 0.02109194
```
...
```
#> [1] 0.01797915 0.01700497 0.01628494 0.02803802 0.01717806
```
...
```
#> [1] 0.003228903 0.002136946 0.002120972 0.003901005 0.003390074
```
