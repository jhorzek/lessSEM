...
run you model a few times, don't want to create a new package and your model
...
2. The fitting function and the gradient function are only allowed tow parameters each:
...
## Approach 3: Including the header files
...
It will come to the same parameter estiamtes:
```{r, echo = FALSE}
head(l1$B)
```
