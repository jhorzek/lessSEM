...
#>   Tuning         ||--||  Estimates                                                        
#>  ------- ------- ||--|| ---------- ---------- ---------- ---------- ---------- -----------
#>   lambda   alpha ||--||  ind60=~x2  ind60=~x3          a          b          c dem60~ind60
#>  ======= ======= ||--|| ========== ========== ========== ========== ========== ===========
#>   0.0000  0.0000 ||--||     1.8164     1.5582     1.1879     1.1706     1.2511      1.4062
#>                                                                                                      
#>                                                                                                      
#>  ----------- ----------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>  dem65~ind60 dem65~dem60     y1~~y5     y2~~y4     y2~~y6     y3~~y7     y4~~y8     y6~~y8     x1~~x1
#>  =========== =========== ========== ========== ========== ========== ========== ========== ==========
#>       0.4696      0.8755     0.5389     1.4270     2.2120     0.7425     0.3718     1.3734     0.0000
#>                                                                                                    
#>                                                                                                    
#>  ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>      x2~~x2     x3~~x3     y1~~y1     y2~~y2     y3~~y3     y4~~y4     y5~~y5     y6~~y6     y7~~y7
#>  ========== ========== ========== ========== ========== ========== ========== ========== ==========
#>      1.3895     1.2086     1.8544     7.5981     4.9592     3.2006     2.2664     4.9911     3.6046
#>                                                                                               
#>                                                                                               
#>  ---------- ------------ ------------ ------------ ---------- ---------- ---------- ----------
#>      y8~~y8 ind60~~ind60 dem60~~dem60 dem65~~dem65       x1~1       x2~1       x3~1       y1~1
#>  ========== ============ ============ ============ ========== ========== ========== ==========
#>      3.3135       0.5305       3.8021       0.2003     5.0409     5.8482     2.5445     5.4463
#>                                                                                                    
#>                                                                                                    
#>  ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>        y2~1       y3~1       y4~1       y5~1       y6~1       y7~1       y8~1 visual=~x2 visual=~x3
#>  ========== ========== ========== ========== ========== ========== ========== ========== ==========
#>      4.2330     6.5420     4.4295     5.1139     2.9502     6.1703     4.0150     0.2791     0.4461
#>                                                                                                      
#>                                                                                                      
#>  ----------- ----------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>  textual=~x5 textual=~x6  speed=~x8  speed=~x9     x4~~x4     x5~~x5     x6~~x6     x7~~x7     x8~~x8
#>  =========== =========== ========== ========== ========== ========== ========== ========== ==========
#>       1.1126      0.9221     1.1746     1.0056     0.3681     0.4434     0.3610     0.7750     0.4590
#>                                                                                                      
#>                                                                                                      
#>  ---------- -------------- ---------------- ------------ --------------- ------------- --------------
#>      x9~~x9 visual~~visual textual~~textual speed~~speed visual~~textual visual~~speed textual~~speed
#>  ========== ============== ================ ============ =============== ============= ==============
#>      0.6025         1.3695           0.9839       0.4084          0.4666        0.2615         0.1746
#>                                                                   
#>                                                                   
#>  ---------- ---------- ---------- ---------- ---------- ----------
#>        x4~1       x5~1       x6~1       x7~1       x8~1       x9~1
#>  ========== ========== ========== ========== ========== ==========
#>      3.0967     4.3804     2.2186     4.2060     5.5507     5.3943
```
