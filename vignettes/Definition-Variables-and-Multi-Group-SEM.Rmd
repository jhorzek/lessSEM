...
#>   Tuning         ||--||  Estimates                                                                                                                      
#>  ------- ------- ||--|| ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- -------------- --------------
#>   lambda   alpha ||--|| l1_Pasteur l2_Pasteur l3_Pasteur         v1         v2         v3         m1         m2         m3 l1_Grant_White l2_Grant_White
#>  ======= ======= ||--|| ========== ========== ========== ========== ========== ========== ========== ========== ========== ============== ==============
#>   0.0000  0.0000 ||--||     0.7240     0.5610     0.8824     0.8449     1.0711     0.6108     4.9212     6.0770     2.2281         0.7088         0.5536
#>                
#>                
#>  --------------
#>  l3_Grant_White
...
#>   Tuning         ||--||  Estimates                                                                                                                            
#>  ------- ------- ||--|| ---------- ---------- ---------- ---------- ---------- ----------- ----------- ----------- ---------- ---------- ---------- ----------
#>   lambda   alpha ||--||  ind60=~x2  ind60=~x3          a          b          c dem60~ind60 dem65~ind60 dem65~dem60     y1~~y5     y2~~y4     y2~~y6     y3~~y7
#>  ======= ======= ||--|| ========== ========== ========== ========== ========== =========== =========== =========== ========== ========== ========== ==========
#>   0.0000  0.0000 ||--||     1.8164     1.5582     1.1879     1.1706     1.2511      1.4062      0.4696      0.8755     0.5389     1.4270     2.2120     0.7425
#>                                                                                                                                                             
#>                                                                                                                                                             
#>  ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ------------
#>      y4~~y8     y6~~y8     x1~~x1     x2~~x2     x3~~x3     y1~~y1     y2~~y2     y3~~y3     y4~~y4     y5~~y5     y6~~y6     y7~~y7     y8~~y8 ind60~~ind60
#>  ========== ========== ========== ========== ========== ========== ========== ========== ========== ========== ========== ========== ========== ============
#>      0.3718     1.3734     0.0000     1.3895     1.2086     1.8544     7.5981     4.9592     3.2006     2.2664     4.9911     3.6046     3.3135       0.5305
#>                                                                                                                                                               
#>                                                                                                                                                               
#>  ------------ ------------ ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>  dem60~~dem60 dem65~~dem65       x1~1       x2~1       x3~1       y1~1       y2~1       y3~1       y4~1       y5~1       y6~1       y7~1       y8~1 visual=~x2
#>  ============ ============ ========== ========== ========== ========== ========== ========== ========== ========== ========== ========== ========== ==========
#>        3.8021       0.2003     5.0409     5.8482     2.5445     5.4463     4.2330     6.5420     4.4295     5.1139     2.9502     6.1703     4.0150     0.2791
#>                                                                                                                                                            
#>                                                                                                                                                            
#>  ---------- ----------- ----------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- -------------- ----------------
#>  visual=~x3 textual=~x5 textual=~x6  speed=~x8  speed=~x9     x4~~x4     x5~~x5     x6~~x6     x7~~x7     x8~~x8     x9~~x9 visual~~visual textual~~textual
#>  ========== =========== =========== ========== ========== ========== ========== ========== ========== ========== ========== ============== ================
#>      0.4461      1.1126      0.9221     1.1746     1.0056     0.3681     0.4434     0.3610     0.7750     0.4590     0.6025         1.3695           0.9839
#>                                                                                                                             
#>                                                                                                                             
#>  ------------ --------------- ------------- -------------- ---------- ---------- ---------- ---------- ---------- ----------
#>  speed~~speed visual~~textual visual~~speed textual~~speed       x4~1       x5~1       x6~1       x7~1       x8~1       x9~1
#>  ============ =============== ============= ============== ========== ========== ========== ========== ========== ==========
#>        0.4084          0.4666        0.2615         0.1746     3.0967     4.3804     2.2186     4.2060     5.5507     5.3943
```
...
#>   lambda   alpha ||--|| l1_Pasteur l2_Pasteur l3_Pasteur         v1         v2         v3         m1         m2         m3 l1_Grant_White l2_Grant_White
#>  ======= ======= ||--|| ========== ========== ========== ========== ========== ========== ========== ========== ========== ============== ==============
#>   0.0000  1.0000 ||--||     0.7241     0.5611     0.8822     0.8447     1.0710     0.6110     4.9211     6.0768     2.2279         0.7089         0.5537
#>                
#>                
#>  --------------
#>  l3_Grant_White
