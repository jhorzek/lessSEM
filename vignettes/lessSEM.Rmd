...
#>   0.0000  1.0000 ||--||     0.7239     0.7319     0.5688    -0.0562
#>                                                                              
#>                                                                              
#>  ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>          l6         l7     y1~~y1     y2~~y2     y3~~y3     y4~~y4     y5~~y5
#>  ========== ========== ========== ========== ========== ========== ==========
#>           .          .     0.8812     1.1477     1.9273     1.0804     0.5710
#>           .          .     0.8742     1.1523     1.9331     1.0818     0.5705
#>           .    -0.0090     0.8631     1.1602     1.9417     1.0838     0.5697
#>           .    -0.0478     0.8528     1.1706     1.9482     1.0841     0.5689
#>      0.0166    -0.0894     0.8491     1.1779     1.9496     1.0830     0.5685
#>                       
#>                       
#>  ---------- ----------
#>      y6~~y6     y7~~y7
...
#>   Tuning         ||--||  Estimates                                 
#>  ------- ------- ||--|| ---------- ---------- ---------- ----------
#>   lambda   theta ||--||         l2         l3         l4         l5
#>  ======= ======= ||--|| ========== ========== ========== ==========
#>   0.0000  2.1000 ||--||     0.7240     0.7320     0.5689    -0.0562
#>   0.3333  2.1000 ||--||     0.7523     0.7535     0.5742          .
#>   0.6667  2.1000 ||--||     0.7523     0.7536     0.5742          .
#>   1.0000  2.1000 ||--||     0.7523     0.7536     0.5742          .
#>   0.0000  5.0000 ||--||     0.7241     0.7322     0.5690    -0.0562
#>   0.3333  5.0000 ||--||     0.7522     0.7534     0.5740          .
#>   0.6667  5.0000 ||--||     0.7522     0.7535     0.5742          .
#>   1.0000  5.0000 ||--||     0.7522     0.7535     0.5742          .
#>                                                                              
#>                                                                              
#>  ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>          l6         l7     y1~~y1     y2~~y2     y3~~y3     y4~~y4     y5~~y5
#>  ========== ========== ========== ========== ========== ========== ==========
#>      0.0166    -0.0894     0.8492     1.1778     1.9495     1.0829     0.5684
#>           .          .     0.8812     1.1478     1.9274     1.0804     0.5710
#>           .          .     0.8812     1.1478     1.9274     1.0804     0.5710
#>           .          .     0.8812     1.1478     1.9274     1.0804     0.5710
#>      0.0166    -0.0894     0.8495     1.1776     1.9492     1.0829     0.5684
#>           .          .     0.8811     1.1478     1.9277     1.0804     0.5711
#>           .          .     0.8811     1.1478     1.9275     1.0804     0.5710
#>           .          .     0.8811     1.1478     1.9275     1.0804     0.5710
#>                       
#>                       
#>  ---------- ----------
...
AICs <- AIC(fitLasso)
head(AICs)
#>       lambda alpha objectiveValue regObjectiveValue     m2LL  regM2LL
#> 1 0.10340887     1       1071.078          1071.078 1071.078 1071.078
#> 2 0.07755666     1       1071.033          1071.074 1071.033 1071.074
#> 3 0.05170444     1       1070.956          1071.048 1070.956 1071.048
#> 4 0.02585222     1       1070.851          1070.967 1070.851 1070.967
#> 5 0.00000000     1       1070.810          1070.810 1070.810 1070.810
#>   nonZeroParameters convergence      AIC
#> 1                10        TRUE 1091.078
#> 2                11        TRUE 1093.033
#> 3                12        TRUE 1094.956
#> 4                12        TRUE 1094.851
...
#> 1 0.1034089     1 0.7522904 0.753614 0.5742228  0  0  0 0.8812416 1.147737
#>    y3~~y3   y4~~y4    y5~~y5    y6~~y6   y7~~y7
#> 1 1.92735 1.080353 0.5710041 0.9628056 1.531997
```
...
#>   lambda   theta ||--||         l2         l3         l4         l5
#>  ======= ======= ||--|| ========== ========== ========== ==========
#>   0.9000  0.1000 ||--||     0.7523     0.7537     0.5742          .
#>                                                                              
#>                                                                              
#>  ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>          l6         l7     y1~~y1     y2~~y2     y3~~y3     y4~~y4     y5~~y5
#>  ========== ========== ========== ========== ========== ========== ==========
#>           .          .     0.8813     1.1478     1.9273     1.0803     0.5710
#>                       
#>                       
#>  ---------- ----------
#>      y6~~y6     y7~~y7
