---
title: "A short introduction to regularized SEM with lessSEM"
...
agains specialized optimizers (the default in lslx is a variant of GLMNET)
...
Instead, we only specified how many lambdas we want to have (`nLambdas=10`).
...
For instance, see ?lasso for more details on the lasso penalty. If you
are interested in the general purpose interface, have a look at ?gpLasso,
?gpMcp, etc. To get more details on implementing the **lessSEM** optimizers in
your own package, have a look at the vignette "The-optimizer-interface" (`vignette('The-optimizer-interface')`) and at the [lessLM](https://github.com/jhorzek/lessLM) package.
