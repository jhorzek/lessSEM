...
#>  ======= ======= ||--|| ========== ========== ========== ========== ========== ========== ========== ==========
#>   0.1034  1.0000 ||--||     0.7523     0.7536     0.5742          .          .          .     0.8812     1.1477
#>   0.0776  1.0000 ||--||     0.7477     0.7480     0.5720    -0.0104          .          .     0.8742     1.1523
#>   0.0517  1.0000 ||--||     0.7399     0.7396     0.5688    -0.0266          .    -0.0090     0.8631     1.1602
#>   0.0259  1.0000 ||--||     0.7301     0.7332     0.5677    -0.0418          .    -0.0478     0.8528     1.1706
#>   0.0000  1.0000 ||--||     0.7239     0.7319     0.5688    -0.0562     0.0166    -0.0894     0.8491     1.1779
#>                                                        
#>                                                        
#>  ---------- ---------- ---------- ---------- ----------
#>      y3~~y3     y4~~y4     y5~~y5     y6~~y6     y7~~y7
#>  ========== ========== ========== ========== ==========
#>      1.9273     1.0804     0.5710     0.9628     1.5320
#>      1.9331     1.0818     0.5705     0.9628     1.5320
#>      1.9417     1.0838     0.5697     0.9628     1.5312
#>      1.9482     1.0841     0.5689     0.9628     1.5282
#>      1.9496     1.0830     0.5685     0.9626     1.5255
```
If you are only interested in the estimates, use

```r
estimates(fitLasso)
#>             l2        l3        l4          l5         l6           l7    y1~~y1   y2~~y2   y3~~y3   y4~~y4
#> [1,] 0.7522904 0.7536140 0.5742228  0.00000000 0.00000000  0.000000000 0.8812416 1.147737 1.927350 1.080353
#> [2,] 0.7476862 0.7480112 0.5720039 -0.01042497 0.00000000  0.000000000 0.8741617 1.152318 1.933141 1.081837
#> [3,] 0.7398991 0.7395932 0.5688300 -0.02660810 0.00000000 -0.008974807 0.8630783 1.160213 1.941722 1.083766
#> [4,] 0.7301019 0.7331646 0.5677000 -0.04181445 0.00000000 -0.047849804 0.8528254 1.170580 1.948163 1.084065
#> [5,] 0.7239003 0.7318701 0.5688230 -0.05624391 0.01658325 -0.089365627 0.8491201 1.177878 1.949609 1.082966
#>         y5~~y5    y6~~y6   y7~~y7
#> [1,] 0.5710041 0.9628056 1.531997
#> [2,] 0.5704936 0.9628058 1.532015
#> [3,] 0.5696926 0.9628057 1.531243
#> [4,] 0.5689390 0.9628055 1.528245
#> [5,] 0.5684702 0.9625805 1.525473
```
...
#>   Tuning         ||--||  Estimates                                                                             
#>  ------- ------- ||--|| ---------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>   lambda   theta ||--||         l2         l3         l4         l5         l6         l7     y1~~y1     y2~~y2
#>  ======= ======= ||--|| ========== ========== ========== ========== ========== ========== ========== ==========
#>   0.0000  2.1000 ||--||     0.7240     0.7320     0.5689    -0.0562     0.0166    -0.0894     0.8492     1.1778
#>   0.3333  2.1000 ||--||     0.7523     0.7535     0.5742          .          .          .     0.8812     1.1478
#>   0.6667  2.1000 ||--||     0.7522     0.7536     0.5742          .          .          .     0.8812     1.1478
#>   1.0000  2.1000 ||--||     0.7522     0.7536     0.5742          .          .          .     0.8812     1.1478
#>   0.0000  5.0000 ||--||     0.7242     0.7323     0.5690    -0.0562     0.0166    -0.0894     0.8495     1.1776
#>   0.3333  5.0000 ||--||     0.7522     0.7535     0.5740          .          .          .     0.8811     1.1479
#>   0.6667  5.0000 ||--||     0.7522     0.7535     0.5742          .          .          .     0.8811     1.1479
#>   1.0000  5.0000 ||--||     0.7522     0.7535     0.5742          .          .          .     0.8811     1.1478
#>                                                        
#>                                                        
#>  ---------- ---------- ---------- ---------- ----------
#>      y3~~y3     y4~~y4     y5~~y5     y6~~y6     y7~~y7
#>  ========== ========== ========== ========== ==========
#>      1.9495     1.0829     0.5684     0.9626     1.5255
#>      1.9274     1.0804     0.5710     0.9628     1.5320
#>      1.9274     1.0804     0.5710     0.9628     1.5320
#>      1.9274     1.0804     0.5710     0.9628     1.5320
#>      1.9493     1.0829     0.5684     0.9626     1.5255
#>      1.9275     1.0805     0.5711     0.9628     1.5320
#>      1.9274     1.0804     0.5710     0.9628     1.5320
#>      1.9275     1.0804     0.5710     0.9628     1.5320
```
...
#>      lambda alpha        l2       l3        l4 l5 l6 l7    y1~~y1   y2~~y2  y3~~y3   y4~~y4    y5~~y5    y6~~y6
#> 1 0.1034089     1 0.7522904 0.753614 0.5742228  0  0  0 0.8812416 1.147737 1.92735 1.080353 0.5710041 0.9628056
#>     y7~~y7
#> 1 1.531997
```
...
#>   lambda   theta ||--||         l2         l3         l4         l5         l6         l7     y1~~y1     y2~~y2
#>  ======= ======= ||--|| ========== ========== ========== ========== ========== ========== ========== ==========
#>   1.0000  0.1000 ||--||     0.7523     0.7536     0.5742          .          .          .     0.8813     1.1477
#>                                                        
#>                                                        
#>  ---------- ---------- ---------- ---------- ----------
#>      y3~~y3     y4~~y4     y5~~y5     y6~~y6     y7~~y7
