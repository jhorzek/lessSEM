...
mp <- lavaanModel |>
  ...
  addLasso(regularized = c("r1", "r2", "r3"), 
           lambdas = seq(0,1,.2)) 
#> Note: 
#> • Mixed penalties is a very new feature. Please note that there may still be bugs in the procedure. Use carefully!
```
...
```r
fitMp@penalty
#>    ind60=~x2    ind60=~x3           c2           c3           c4    dem60=~y2    dem60=~y3    dem60=~y4    dem65=~y6    dem65=~y7            c           r1 
#>       "none"       "none"      "lasso"      "lasso"      "lasso"       "none"       "none"       "none"       "none"       "none"       "none"       "scad" 
#>           r2           r3       x1~~x1       x2~~x2       x3~~x3       y2~~y2       y3~~y3       y4~~y4       y1~~y1       y5~~y5       y6~~y6       y7~~y7 
#>       "scad"       "scad"       "none"       "none"       "none"       "none"       "none"       "none"       "none"       "none"       "none"       "none" 
...
#>                        Tuning ||--||  Estimates                                                                                                              
#>  ---------------------------- ||--|| ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>  tuningParameterConfiguration ||--||  ind60=~x2  ind60=~x3         c2         c3         c4  dem60=~y2  dem60=~y3  dem60=~y4  dem65=~y6  dem65=~y7          c
#>  ============================ ||--|| ========== ========== ========== ========== ========== ========== ========== ========== ========== ========== ==========
#>                       11.0000 ||--||     2.1817     1.8188          .          .          .     1.3540     1.0440     1.2995     1.2585     1.2825     1.3098
#>                                                                                                                                                           
#>                                                                                                                                                           
#>  ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>          r1         r2         r3     x1~~x1     x2~~x2     x3~~x3     y2~~y2     y3~~y3     y4~~y4     y1~~y1     y5~~y5     y6~~y6     y7~~y7     y8~~y8
#>  ========== ========== ========== ========== ========== ========== ========== ========== ========== ========== ========== ========== ========== ==========
#>      1.4738     0.4532     0.8644     0.0818     0.1184     0.4673     6.4896     5.3399     2.8871     1.9419     2.3901     4.3429     3.5095     2.9402
#>                                        
#>                                        
#>  ------------ ------------ ------------
#>  ind60~~ind60 dem60~~dem60 dem65~~dem65
#>  ============ ============ ============
#>        0.4481       3.8717       0.1149
```
...
#>  tuningParameterConfiguration ||--||  ind60=~x2  ind60=~x3         c2         c3         c4  dem60=~y2  dem60=~y3  dem60=~y4  dem65=~y6  dem65=~y7          c
#>  ============================ ||--|| ========== ========== ========== ========== ========== ========== ========== ========== ========== ========== ==========
#>                       11.0000 ||--||     2.1818     1.8188          .          .          .     1.3541     1.0441     1.2997     1.2586     1.2825     1.3099
#>                                                                                                                                                           
#>                                                                                                                                                           
#>  ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>          r1         r2         r3     x1~~x1     x2~~x2     x3~~x3     y2~~y2     y3~~y3     y4~~y4     y1~~y1     y5~~y5     y6~~y6     y7~~y7     y8~~y8
#>  ========== ========== ========== ========== ========== ========== ========== ========== ========== ========== ========== ========== ========== ==========
#>      1.4740     0.4532     0.8643     0.0818     0.1184     0.4672     6.4892     5.3396     2.8861     1.9420     2.3904     4.3421     3.5090     2.9392
#>                                        
#>                                        
#>  ------------ ------------ ------------
#>  ind60~~ind60 dem60~~dem60 dem65~~dem65
#>  ============ ============ ============
#>        0.4482       3.8710       0.1159
```
The `tuningParameterConfiguration` refers to the rows in the lambda, theta, and alpha
matrices that resulted in the best fit:
...
model from above: Five repetitions using ista took 40.479 seconds,
while glmnet took 1.751 seconds. That is, if you 
