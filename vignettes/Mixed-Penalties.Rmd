...
model from above: Five repetitions using ista took `r round(difftime(end_ista, start_ista),3)` seconds,
while glmnet took `r round(difftime(end_glmnet, start_glmnet),3)` seconds. That is, if you 
