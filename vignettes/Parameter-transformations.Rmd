...
#>                                                                                                                
#>  ----------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>  dem65~dem60     y1~~y5     y2~~y4     y3~~y7     y4~~y8     y6~~y8     x1~~x1     x2~~x2     x3~~x3     y1~~y1
#>  =========== ========== ========== ========== ========== ========== ========== ========== ========== ==========
#>       0.8659     0.5552     1.5947     0.7807     0.6537     1.5350     0.0820     0.1177     0.4675     1.7929
#>                                                                                                        
#>                                                                                                        
#>  ---------- ---------- ---------- ---------- ---------- ---------- ---------- ------------ ------------
#>      y2~~y2     y3~~y3     y4~~y4     y5~~y5     y6~~y6     y7~~y7     y8~~y8 ind60~~ind60 dem60~~dem60
#>  ========== ========== ========== ========== ========== ========== ========== ============ ============
#>      7.3843     5.0175     3.4074     2.2857     4.8977     3.5510     3.4511       0.4480       3.9408
#>                                                                                       
#>                                                ||--||  Transform                      
#>  ------------ ---------- ---------- ---------- ||--|| ---------- ---------- ----------
#>  dem65~~dem65   delta_a2   delta_b2   delta_c2 ||--||         a2         b2         c2
#>  ============ ========== ========== ========== ||--|| ========== ========== ==========
#>        0.2034          .          .          . ||--||     1.2110     1.1679     1.2340
```
...
#>   Tuning         ||--||  Estimates                                                                             
#>  ------- ------- ||--|| ---------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>   lambda   alpha ||--||         a1 eta1~~eta1          v         l2         l3      mvar1      mvar2      mvar3
#>  ======= ======= ||--|| ========== ========== ========== ========== ========== ========== ========== ==========
#>   0.2790  1.0000 ||--||     0.4665     1.1055     0.8051     0.5696     0.6754     0.0533     0.7428     0.6500
#>                                                                                                               
#>                                                                                                               
#>  ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>     y1_t1~1    y2_t1~1    y3_t1~1    y1_t2~1    y2_t2~1    y3_t2~1    y1_t3~1    y2_t3~1    y3_t3~1    y1_t4~1
#>  ========== ========== ========== ========== ========== ========== ========== ========== ========== ==========
#>     -0.1545    -0.0878    -0.1745    -0.1565    -0.0492    -0.0849    -0.1499    -0.0302    -0.1572    -0.0952
#>                                                                                                               
#>                                                                                                               
#>  ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>     y2_t4~1    y3_t4~1    y1_t5~1    y2_t5~1    y3_t5~1    y1_t6~1    y2_t6~1    y3_t6~1    y1_t7~1    y2_t7~1
#>  ========== ========== ========== ========== ========== ========== ========== ========== ========== ==========
#>     -0.0224    -0.0798     0.0374    -0.0231     0.0576     0.0502     0.0651    -0.0020    -0.0466     0.0678
#>                                                                                                               
#>                                                                                                               
#>  ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>     y3_t7~1    y1_t8~1    y2_t8~1    y3_t8~1    y1_t9~1    y2_t9~1    y3_t9~1   y1_t10~1   y2_t10~1   y3_t10~1
#>  ========== ========== ========== ========== ========== ========== ========== ========== ========== ==========
#>     -0.0383    -0.0221    -0.0279    -0.0476    -0.0775    -0.0579    -0.0407     0.0131    -0.0118    -0.0043
#>                                                                                                           
#>                                                                                          ||--||  Transform
#>  ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ||--|| ----------
#>      delta2     delta3     delta4     delta5     delta6     delta7     delta8     delta9 ||--||         a2
#>  ========== ========== ========== ========== ========== ========== ========== ========== ||--|| ==========
#>           .          .    -0.2807          .          .          .          .          . ||--||     0.4665
#>                                                                              
#>                                                                              
...
#>  ========== ========== ========== ========== ========== ========== ==========
#>      0.4665     0.1859     0.1859     0.1859     0.1859     0.1859     0.1859
```
...
#>   Tuning         ||--||  Estimates                                                                             
#>  ------- ------- ||--|| ---------- ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>   lambda   alpha ||--|| eta0~~eta0     eta0~1         l2         l3      mvar1      mvar2      mvar3     mMean1
#>  ======= ======= ||--|| ========== ========== ========== ========== ========== ========== ========== ==========
#>   0.0000  0.0000 ||--||     0.8736    -0.0902     0.5780     0.7453     0.1280     0.7504     0.5775    -0.0267
#>                                                                          
#>                                              ||--||  Transform           
#>  ---------- ---------- ---------- ---------- ||--|| ---------- ----------
#>      mMean2     mMean3        ctA        ctV ||--||          a          v
#>  ========== ========== ========== ========== ||--|| ========== ==========
#>      0.0054    -0.0276    -0.5228     0.7899 ||--||     0.5928     0.3870
```
