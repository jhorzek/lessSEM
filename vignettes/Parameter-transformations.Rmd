...
lessSEM:
```{r}
matrix(unlist(coef(lessSEMFit)[,c("ctA_11", "ctA_21", "ctA_12", "ctA_22")]),2,2)
```
ctsemOMX:
```{r}
...
lessSEM:
```{r}
matrix(unlist(coef(lessSEMFit)[,c("ctV_11", "ctV_12", "ctV_12", "ctV_22")]),2,2)
```
