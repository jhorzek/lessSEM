...
#>  ======= ======= ||--|| ========== ========== ========== ==========
#>   0.2216  1.0000 ||--||     2.1825     1.8189     1.2110     1.1679
#>                                                                      
#>                                                                      
#>  ---------- ----------- ----------- ----------- ---------- ----------
#>          c1 dem60~ind60 dem65~ind60 dem65~dem60     y1~~y5     y2~~y4
#>  ========== =========== =========== =========== ========== ==========
#>      1.2340      1.4534      0.5935      0.8659     0.5552     1.5947
#>                                                                              
#>                                                                              
#>  ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>      y3~~y7     y4~~y8     y6~~y8     x1~~x1     x2~~x2     x3~~x3     y1~~y1
#>  ========== ========== ========== ========== ========== ========== ==========
#>      0.7807     0.6537     1.5350     0.0820     0.1177     0.4675     1.7929
#>                                                                              
#>                                                                              
#>  ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>      y2~~y2     y3~~y3     y4~~y4     y5~~y5     y6~~y6     y7~~y7     y8~~y8
#>  ========== ========== ========== ========== ========== ========== ==========
#>      7.3843     5.0175     3.4074     2.2857     4.8977     3.5510     3.4511
#>                                                                         
#>                                                                         
#>  ------------ ------------ ------------ ---------- ---------- ----------
...
#>   Tuning         ||--||  Estimates                                 
#>  ------- ------- ||--|| ---------- ---------- ---------- ----------
#>   lambda   alpha ||--||         a1 eta1~~eta1          v         l2
#>  ======= ======= ||--|| ========== ========== ========== ==========
#>   0.2790  1.0000 ||--||     0.4665     1.1055     0.8051     0.5696
#>                                                                              
#>                                                                              
#>  ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>          l3      mvar1      mvar2      mvar3    y1_t1~1    y2_t1~1    y3_t1~1
#>  ========== ========== ========== ========== ========== ========== ==========
#>      0.6754     0.0533     0.7428     0.6500    -0.1546    -0.0878    -0.1746
#>                                                                              
#>                                                                              
#>  ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>     y1_t2~1    y2_t2~1    y3_t2~1    y1_t3~1    y2_t3~1    y3_t3~1    y1_t4~1
#>  ========== ========== ========== ========== ========== ========== ==========
#>     -0.1565    -0.0492    -0.0849    -0.1499    -0.0302    -0.1572    -0.0952
#>                                                                              
#>                                                                              
#>  ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>     y2_t4~1    y3_t4~1    y1_t5~1    y2_t5~1    y3_t5~1    y1_t6~1    y2_t6~1
#>  ========== ========== ========== ========== ========== ========== ==========
#>     -0.0224    -0.0798     0.0373    -0.0231     0.0576     0.0502     0.0650
#>                                                                              
#>                                                                              
#>  ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>     y3_t6~1    y1_t7~1    y2_t7~1    y3_t7~1    y1_t8~1    y2_t8~1    y3_t8~1
#>  ========== ========== ========== ========== ========== ========== ==========
#>     -0.0020    -0.0465     0.0678    -0.0383    -0.0221    -0.0279    -0.0476
#>                                                                              
#>                                                                              
#>  ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>     y1_t9~1    y2_t9~1    y3_t9~1   y1_t10~1   y2_t10~1   y3_t10~1     delta2
#>  ========== ========== ========== ========== ========== ========== ==========
#>     -0.0775    -0.0579    -0.0407     0.0131    -0.0118    -0.0043          .
#>                                                                              
#>                                                                              
#>  ---------- ---------- ---------- ---------- ---------- ---------- ----------
...
```
#> [1] 0.4664992 0.4664992 0.4664992 0.1858526 0.1858526 0.1858526 0.1858526
#> [8] 0.1858526 0.1858526
```
...
#>   Tuning         ||--||  Estimates                                 
#>  ------- ------- ||--|| ---------- ---------- ---------- ----------
#>   lambda   alpha ||--|| eta0~~eta0     eta0~1         l2         l3
#>  ======= ======= ||--|| ========== ========== ========== ==========
#>   0.0000  0.0000 ||--||     0.8736    -0.0902     0.5780     0.7453
#>                                                                              
#>                                                                              
#>  ---------- ---------- ---------- ---------- ---------- ---------- ----------
#>       mvar1      mvar2      mvar3     mMean1     mMean2     mMean3        ctA
#>  ========== ========== ========== ========== ========== ========== ==========
#>      0.1280     0.7504     0.5775    -0.0267     0.0054    -0.0276    -0.5228
#>                                         
#>             ||--||  Transform           
#>  ---------- ||--|| ---------- ----------
#>         ctV ||--||          a          v
#>  ========== ||--|| ========== ==========
#>      0.7899 ||--||     0.5928     0.3870
```
