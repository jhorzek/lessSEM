...
#>    2.1796566    1.8182100    1.1907820    1.1745407    1.2509789    1.4713302    0.6004746 
#>  dem65~dem60       y1~~y5       y2~~y4       y2~~y6       y3~~y7       y4~~y8       y6~~y8 
#>    0.8650430    0.5825389    1.4402477    2.1829448    0.7115901    0.3627964    1.3717741 
#>       x1~~x1       x2~~x2       x3~~x3       y1~~y1       y2~~y2       y3~~y3       y4~~y4 
#>    0.0813878    0.1204271    0.4666596    1.8546417    7.5813926    4.9556766    3.2245521 
#>       y5~~y5       y6~~y6       y7~~y7       y8~~y8 ind60~~ind60 dem60~~dem60 dem65~~dem65 
#>    2.3130404    4.9681408    3.5600367    3.3076854    0.4485989    3.8753039    0.1644633 
#>         x1~1         x2~1         x3~1         y1~1         y2~1         y3~1         y4~1 
#>    5.0543838    4.7921946    3.5576898    5.4646667    4.2564429    6.5631103    4.4525330 
#>         y5~1         y6~1         y7~1         y8~1 
#>    5.1362519    2.9780741    6.1962639    4.0433897 
#> 
#> -2 log-Likelihood: 3097.6361581071
```
...
#>    0.8650430    0.5825389    1.4402477    2.1829448    0.7115901    0.3627964    1.3717741 
#>       x1~~x1       x2~~x2       x3~~x3       y1~~y1       y2~~y2       y3~~y3       y4~~y4 
#>   -2.5085299   -2.1167106   -0.7621551    0.6176915    2.0256969    1.6005337    1.1707941 
#>       y5~~y5       y6~~y6       y7~~y7       y8~~y8 ind60~~ind60 dem60~~dem60 dem65~~dem65 
#>    0.8385629    1.6030457    1.2697708    1.1962487   -0.8016262    1.3546241   -1.8050678 
#>         x1~1         x2~1         x3~1         y1~1         y2~1         y3~1         y4~1 
#>    5.0543838    4.7921946    3.5576898    5.4646667    4.2564429    6.5631103    4.4525330 
#>         y5~1         y6~1         y7~1         y8~1 
#>    5.1362519    2.9780741    6.1962639    4.0433897
...
#>    ind60=~x2    ind60=~x3            a            b            c  dem60~ind60  dem65~ind60 
#>    2.1796566    1.8182100    1.0000000    1.1745407    1.2509789    1.4713302    0.6004746 
#>  dem65~dem60       y1~~y5       y2~~y4       y2~~y6       y3~~y7       y4~~y8       y6~~y8 
#>    0.8650430    0.5825389    1.4402477    2.1829448    0.7115901    0.3627964    1.3717741 
#>       x1~~x1       x2~~x2       x3~~x3       y1~~y1       y2~~y2       y3~~y3       y4~~y4 
#>    0.0813878    0.1204271    0.4666596    1.8546417    7.5813926    4.9556766    3.2245521 
...
print(opt$par)
#>    ind60=~x2    ind60=~x3            a            b            c  dem60~ind60  dem65~ind60 
#>    2.1791276    1.8180458    1.1909397    1.1740909    1.2511328    1.4725867    0.6007137 
#>  dem65~dem60       y1~~y5       y2~~y4       y2~~y6       y3~~y7       y4~~y8       y6~~y8 
#>    0.8649836    0.5817910    1.4336940    2.1828828    0.7229781    0.3605874    1.3774602 
#>       x1~~x1       x2~~x2       x3~~x3       y1~~y1       y2~~y2       y3~~y3       y4~~y4 
#>   -2.5093044   -2.1126718   -0.7633056    0.6178333    2.0246995    1.6022529    1.1690474 
#>       y5~~y5       y6~~y6       y7~~y7       y8~~y8 ind60~~ind60 dem60~~dem60 dem65~~dem65 
#>    0.8385775    1.6039528    1.2711405    1.1971146   -0.8013687    1.3542390   -1.8057174 
#>         x1~1         x2~1         x3~1         y1~1         y2~1         y3~1         y4~1 
#>    5.0543838    4.7921946    3.5576898    5.4646667    4.2564429    6.5631103    4.4525330 
#>         y5~1         y6~1         y7~1         y8~1 
#>    5.1362519    2.9780741    6.1962639    4.0433897
...
#>    ind60=~x2    ind60=~x3            a            b            c  dem60~ind60  dem65~ind60 
#>   2.17912764   1.81804575   1.19093968   1.17409087   1.25113276   1.47258673   0.60071368 
#>  dem65~dem60       y1~~y5       y2~~y4       y2~~y6       y3~~y7       y4~~y8       y6~~y8 
#>   0.86498364   0.58179103   1.43369401   2.18288278   0.72297808   0.36058737   1.37746019 
#>       x1~~x1       x2~~x2       x3~~x3       y1~~y1       y2~~y2       y3~~y3       y4~~y4 
#>   0.08132479   0.12091448   0.46612308   1.85490471   7.57383439   4.96420359   3.21892497 
#>       y5~~y5       y6~~y6       y7~~y7       y8~~y8 ind60~~ind60 dem60~~dem60 dem65~~dem65 
#>   2.31307420   4.97264951   3.56491599   3.31055101   0.44871438   3.87381195   0.16435650 
#>         x1~1         x2~1         x3~1         y1~1         y2~1         y3~1         y4~1 
#>   5.05438384   4.79219463   3.55768979   5.46466667   4.25644288   6.56311025   4.45253304 
#>         y5~1         y6~1         y7~1         y8~1 
#>   5.13625192   2.97807408   6.19626389   4.04338968
```
...
```r
coef(lavaanModel)
#>    ind60=~x2    ind60=~x3            a            b            c            a            b 
#>        2.180        1.818        1.191        1.175        1.251        1.191        1.175 
#>            c  dem60~ind60  dem65~ind60  dem65~dem60       y1~~y5       y2~~y4       y2~~y6 
#>        1.251        1.471        0.600        0.865        0.583        1.440        2.183 
#>       y3~~y7       y4~~y8       y6~~y8       x1~~x1       x2~~x2       x3~~x3       y1~~y1 
#>        0.712        0.363        1.372        0.081        0.120        0.467        1.855 
#>       y2~~y2       y3~~y3       y4~~y4       y5~~y5       y6~~y6       y7~~y7       y8~~y8 
#>        7.581        4.956        3.225        2.313        4.968        3.560        3.308 
#> ind60~~ind60 dem60~~dem60 dem65~~dem65 
#>        0.449        3.875        0.164
```
...
#>    ind60=~x2    ind60=~x3            a            b            c  dem60~ind60  dem65~ind60 
#>   0.13885220   0.15204331   0.14166120   0.11987057   0.12295636   0.39139697   0.23828913 
#>  dem65~dem60       y1~~y5       y2~~y4       y2~~y6       y3~~y7       y4~~y8       y6~~y8 
#>   0.07567860   0.36462027   0.68977246   0.73096921   0.62119518   0.46062833   0.57969391 
#>       x1~~x1       x2~~x2       x3~~x3       y1~~y1       y2~~y2       y3~~y3       y4~~y4 
#>   0.01968652   0.06991196   0.08897395   0.45717112   1.34332165   0.96373268   0.74092220 
#>       y5~~y5       y6~~y6       y7~~y7       y8~~y8 ind60~~ind60 dem60~~dem60 dem65~~dem65 
#>   0.48364101   0.89600782   0.73922563   0.71425329   0.08675480   0.88802928   0.23331748 
#>         x1~1         x2~1         x3~1         y1~1         y2~1         y3~1         y4~1 
#>   0.08406657   0.17326967   0.16121433   0.29892606   0.43891242   0.39404806   0.37957637 
#>         y5~1         y6~1         y7~1         y8~1 
#>   0.30446534   0.39247640   0.36442149   0.37545879
```
