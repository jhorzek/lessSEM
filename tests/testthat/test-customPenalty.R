...
"
  ...
  testthat::expect_equal(all(round((regsemExact@parameters[,regsemExact@parameterLabels] -
                                      regsemApprox@parameters[,regsemExact@parameterLabels]),2) == 0), TRUE)
  ...
  plot(CV)
  # To extract the best parameter estimates:
  testthat::expect_equal(all(coef(aCV) - coef(CV)==0),TRUE)
  ...
  testthat::expect_equal(all(round(regsemApprox2@parameters[,regsemApprox2@parameterLabels] -
         regsemApprox@parameters[,regsemApprox2@parameterLabels], 2) == 0), TRUE)
  ...
  testthat::expect_equal(all(round(regsemApprox3@parameters[,regsemApprox3@parameterLabels] -
         regsemApprox2@parameters[,regsemApprox3@parameterLabels],2) == 0), TRUE)
